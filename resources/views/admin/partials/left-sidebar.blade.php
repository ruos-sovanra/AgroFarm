  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="{{route('category.index')}}" class="nav-link {{$current_route=='category.index'?'active':''}}">
            <i class="nav-icon fas fa-tachometer-alt"></i>
            <p>
              Category
            </p>
        ...
        <li class="nav-item">
          <a href="{{route('product.index')}}" class="nav-link {{$current_route=='product.index'?'active':''}}">
            <i class="nav-icon fas fa-tachometer-alt"></i>
            <p>
              Product
            </p>
